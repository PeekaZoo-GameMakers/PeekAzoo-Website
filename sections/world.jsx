...
function World() {
  const characters = [
    ...
    },
    {
      ...
      img: 'assets/character-panda.png',
    ...
    <section id="world" className="pz-section cream-deep">
      <div className="pz-container">
        <div className="pz-section-intro--center">
          <Reveal from="up"><span className="pz-eyebrow"><span className="dot" style={{ background: PZ.pink }}/>The Peek-A-Zoo world</span></Reveal>
        ...
        {/* Character selector */}
        <Reveal from="up">
          <div className="pz-char-strip pz-stagger" style={{
            marginTop: 28, display: 'grid', gridTemplateColumns: 'repeat(5, 1fr)', gap: 14,
          }}>
            {characters.map((c, i) => (
              <Reveal key={c.id} from="pop">
